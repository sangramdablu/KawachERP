...
$(document).ready(function () {
    ...
    /* ===============================
       1. Skeleton Loader Generator
       =============================== */
    function showSkeletonRows() {
        const colCount = $('#studentsTable thead th').length;
        let skeletonHtml = '';
    ...
    const table = $('#studentsTable').DataTable({
        ajax: {
            ...
            data: function (d) {
                d.class_id = $('#addClassSelect').val();
            },
            beforeSend: function () {
                showSkeletonRows();
            },
            dataSrc: function (json) {
                $('#studentsTable tbody').removeClass('skeleton-loading');
                return json.data;
            }
        },
        ...
        columns: [
            ...
            { data: 'email' },
            {
                ...
                className: 'text-center',
                render: data =>
                    data ? `<span class="badge bg-primary">${data}</span>` : ''
            },
            {
                data: 'created_at',
                width: '10%',
        ...
        dom: `<"row mb-1 align-items-center"
                <"col-md-6 text-start"i>
                <"col-md-6 text-end"f>>
              rt
              <"row mt-1 align-items-center"
                <"col-md-6 text-start"l>
                <"col-md-6 text-end"p>>`,
