...
@section('content')
    ...
    <style>
        ...
        :root {
            --bs-primary-light: #a267f6;
            /* Main Purple/Magenta */
            --bs-success-teal: #00bcd4;
            /* Accent Teal/Cyan */
            --bs-body-bg: #f5f6fa;
            /* Light background */
        ...
        .card.shadow-lg {
            box-shadow: 0 1rem 3rem rgba(162, 103, 246, 0.2) !important;
            /* Stronger purple shadow */
                                ...
                                <div class="container-fluid py-5">
                                    <div class="row justify-content-center">
                                        <div class="col-lg-10">
                                            ...
                                            <header
                                                ...
                                                <h1 class="fs-3 fw-bolder text-dark">
                                                    <i data-lucide="plus-circle"
                                                        class="w-6 h-6 me-2 text-primary-light"></i>
                                                    Create New Class
                                                </h1>
                                                <a href="#"
                                                    class="btn btn-outline-secondary d-flex align-items-center rounded-3 shadow-sm">
                                            ...
                                            <div id="successMessage" class="alert alert-success d-none rounded-3"
                                                role="alert">
                                                <h4 class="alert-heading"><i data-lucide="check-circle"
                                                        class="w-5 h-5 me-2"></i> Class Created Successfully!</h4>
                                            ...
                                            <div class="card shadow-lg border-0 rounded-4">
                                                <div class="card-header card-header-gradient rounded-top-4">
                                                    ...
                                                    <p class="text-white-50 mb-0">Fill in the mandatory information to set
                                                        up the new class section.</p>
                                                </div>
                                                <div class="card-body p-4 p-md-5">
                                                    <form id="classForm" action="#" method="POST" class="needs-validation"
                                                        novalidate>

                                                        <!-- Section 1: Core Identification -->
                                                        <div class="row g-4 mb-4 pb-4 border-bottom">
                                                            <h3 class="fs-6 fw-bold text-dark mb-3">1. Identification &
                                                                Grade</h3>

                                                            <div class="col-md-6">
                                                                <label for="className" class="form-label fw-semibold">Class
                                                                    Name / Section Identifier <span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" class="form-control rounded-3"
                                                                    id="className" name="class_name"
                                                                    placeholder="e.g., Grade 10 - B" required>
                                                                <div class="invalid-feedback">Please provide a unique class
                                                                    name.</div>
                                                                <small class="form-text text-muted">Unique name for this
                                                                    class section (e.g., Grade 7 A).</small>
                                                            </div>

                                                            <div class="col-md-3">
                                                                <label for="gradeLevel" class="form-label fw-semibold">Grade
                                                                    Level <span class="text-danger">*</span></label>
                                                                <select class="form-select rounded-3" id="gradeLevel"
                                                                ...
                                                                <div class="invalid-feedback">Please select a grade level.
                                                                </div>
                                                            </div>

                                                            <div class="col-md-3">
                                                                <label for="maxCapacity" class="form-label fw-semibold">Max
                                                                    Capacity</label>
                                                                <input type="number" class="form-control rounded-3"
                                                                    id="maxCapacity" name="max_capacity"
                                                                    placeholder="e.g., 40" min="1" value="40">
                                                            </div>
                                                        </div>

                                                        <!-- Live Preview Area -->
                                                        <div class="mb-5 d-flex align-items-center">
                                                            <span class="fw-semibold me-3 text-dark">Live Class Name
                                                                Preview:</span>
                                                            <span id="classPreview" class="class-preview-badge">Class
                                                                Preview</span>
                                                        </div>

                                                        <!-- Section 2: Teacher and Schedule -->
                                                        <div class="row g-4 mb-4 pb-4 border-bottom">
                                                            <h3 class="fs-6 fw-bold text-dark mb-3">2. Teacher Assignment &
                                                                Schedule</h3>

                                                            <div class="col-md-6">
                                                                <label for="classTeacher"
                                                                    class="form-label fw-semibold">Class Teacher <span
                                                                        class="text-danger">*</span></label>
                                                                <select class="form-select rounded-3" id="classTeacher"
                                                                    name="class_teacher_id" required>
                                                                    <option value="" selected disabled>Select Class Teacher
                                                                    </option>
                                                                    <option value="1001" data-name="Mrs. Jane Doe">Mrs. Jane
                                                                        Doe (ID: 1001)</option>
                                                                    <option value="1002" data-name="Mr. John Smith">Mr. John
                                                                        Smith (ID: 1002)</option>
                                                                    <option value="1003" data-name="Dr. Alice Chen">Dr.
                                                                        Alice Chen (ID: 1003)</option>
                                                                    <option value="0" data-name="Unassigned">Unassigned (To
                                                                        be set later)</option>
                                                                </select>
                                                                <div class="invalid-feedback">Please select a class teacher.
                                                                </div>
                                                            </div>

                                                            <div class="col-md-6">
                                                                <label for="teacherIDDisplay"
                                                                    class="form-label fw-semibold">Selected Teacher
                                                                    ID</label>
                                                                <input type="text" class="form-control rounded-3 bg-light"
                                                                    id="teacherIDDisplay" readonly
                                                                    placeholder="ID will appear here">
                                                            </div>

                                                            <div class="col-12">
                                                                <label for="scheduleTime"
                                                                    class="form-label fw-semibold">Daily Schedule
                                                                    Time</label>
                                                                <input type="text" class="form-control rounded-3"
                                                                    id="scheduleTime" name="schedule_time"
                                                                    placeholder="e.g., Mon-Fri, 08:00 AM - 03:00 PM">
                                                            </div>
                                                        </div>

                                                        <!-- Section 3: Subject Configuration -->
                                                        <div class="row g-4 mb-5">
                                                            <h3 class="fs-6 fw-bold text-dark mb-3">3. Associated Subjects
                                                            </h3>

                                                            <div class="col-12">
                                                                <label class="form-label fw-semibold">Select Core
                                                                    Subjects</label>
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                value="math" id="subjectMath"
                                                                                name="subjects[]">
                                                                            <label class="form-check-label"
                                                                                for="subjectMath">Mathematics</label>
                                                                        </div>
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                value="science" id="subjectScience"
                                                                                name="subjects[]">
                                                                            <label class="form-check-label"
                                                                                for="subjectScience">Science</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                value="history" id="subjectHistory"
                                                                                name="subjects[]">
                                                                            <label class="form-check-label"
                                                                                for="subjectHistory">History</label>
                                                                        </div>
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                value="language" id="subjectLanguage"
                                                                                name="subjects[]">
                                                                            <label class="form-check-label"
                                                                                for="subjectLanguage">Language Arts</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                value="art" id="subjectArt"
                                                                                name="subjects[]">
                                                                            <label class="form-check-label"
                                                                                for="subjectArt">Art & Design</label>
                                                                        </div>
                                                                        <div class="form-check form-check-inline">
                                                                            <input class="form-check-input" type="checkbox"
                                                                                value="pe" id="subjectPE" name="subjects[]">
                                                                            <label class="form-check-label"
                                                                                for="subjectPE">Physical Education</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="d-flex justify-content-end gap-3">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-success-gradient rounded-3">
        ...
        <div class="card-body">
            {{-- <header
                ...
                <div class="d-flex gap-3">
                    <button
                        class="btn btn-outline-secondary d-flex align-items-center rounded-5 shadow-sm transition duration-150">
                        <i data-lucide="arrow-down-to-line" class="w-4 h-4 me-2"></i>
                        Export
                    </button>
                    <button id="addRowBtn" type="button"
                        class="add-row-btn btn text-white fw-semibold py-2 px-4 rounded-pill d-flex align-items-center shadow-lg"
                        style="background: linear-gradient(45deg, #e83e8c, #d12e7e);">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div id="successMessage" class="alert alert-success d-none rounded-3" role="alert">
                            <h4 class="alert-heading"><i data-lucide="check-circle" class="w-5 h-5 me-2"></i> Class Created
                                Successfully!</h4>
                            <p id="successText" class="mb-0"></p>
                        </div>
                        ...
                        <div class="card shadow-lg border-0 rounded-4">
                            <div class="card-header card-header-gradient rounded-top-4">
                                <h2 class="fs-5 fw-semibold mb-0">Class Details Configuration</h2>
                                <p class="text-white-50 mb-0">Fill in the mandatory information to set up the new class
                                    section.</p>
                            </div>
                            <div class="card-body p-4 p-md-5">
                                <form id="classForm" action="#" method="POST" class="needs-validation" novalidate>
                                    ...
                                    <div class="row g-4 mb-4 pb-4 border-bottom">
                                        ...
                                        <div class="col-md-6">
                                            <label for="className" class="form-label fw-semibold">Class Name / Section
                                                Identifier <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control rounded-3" id="className"
                                                name="class_name" placeholder="e.g., Grade 10 - B" required>
                                            <div class="invalid-feedback">Please provide a unique class name.</div>
                                            <small class="form-text text-muted">Unique name for this class section (e.g.,
                                                Grade 7 A).</small>
                                        </div>

                                        <div class="col-md-3">
                                            <label for="gradeLevel" class="form-label fw-semibold">Grade Level <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select rounded-3" id="gradeLevel" name="grade_level"
                                                required>
                                                <option value="" selected disabled>Select Grade</option>
                                                <option value="1">Grade 1 (Primary)</option>
                                                <option value="5">Grade 5 (Intermediate)</option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" class="form-control rounded-3" id="maxCapacity"
                                                name="max_capacity" placeholder="e.g., 40" min="1" value="40">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-4 mb-4 pb-4 border-bottom">
                                        ...
                                        <div class="col-md-6">
                                            <label for="classTeacher" class="form-label fw-semibold">Class Teacher <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select rounded-3" id="classTeacher" name="class_teacher_id"
                                                required>
                                                <option value="" selected disabled>Select Class Teacher</option>
                                                <option value="1001" data-name="Mrs. Jane Doe">Mrs. Jane Doe (ID: 1001)
                                                </option>
                                                <option value="1002" data-name="Mr. John Smith">Mr. John Smith (ID: 1002)
                                                </option>
                                                <option value="1003" data-name="Dr. Alice Chen">Dr. Alice Chen (ID: 1003)
                                                </option>
                                                <option value="0" data-name="Unassigned">Unassigned (To be set later)
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            <label for="teacherIDDisplay" class="form-label fw-semibold">Selected Teacher
                                                ID</label>
                                            <input type="text" class="form-control rounded-3 bg-light" id="teacherIDDisplay"
                                                readonly placeholder="ID will appear here">
                                        </div>

                                        <div class="col-12">
                                            <label for="scheduleTime" class="form-label fw-semibold">Daily Schedule
                                                Time</label>
                                            <input type="text" class="form-control rounded-3" id="scheduleTime"
                                                name="schedule_time" placeholder="e.g., Mon-Fri, 08:00 AM - 03:00 PM">
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="math"
                                                            id="subjectMath" name="subjects[]">
                                                        <label class="form-check-label"
                                                            for="subjectMath">Mathematics</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="science"
                                                            id="subjectScience" name="subjects[]">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="history"
                                                            id="subjectHistory" name="subjects[]">
                                                        <label class="form-check-label" for="subjectHistory">History</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="language"
                                                            id="subjectLanguage" name="subjects[]">
                                                        <label class="form-check-label" for="subjectLanguage">Language
                                                            Arts</label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="art"
                                                            id="subjectArt" name="subjects[]">
                                                        <label class="form-check-label" for="subjectArt">Art &
                                                            Design</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="checkbox" value="pe"
                                                            id="subjectPE" name="subjects[]">
                                                        <label class="form-check-label" for="subjectPE">Physical
                                                            Education</label>
                                                    </div>
                                                </div>
                                            </div>
